Ext.define('AM.controller.pregunta.List', {
    ...
    //Mdoc: para hacer referencias a otros controllers definirlo siempre en m�todos, no hacer el M.controller.get directamente
    ...
    //los getter (this.getPregunta) necesitar�n un componente para subir hasta la vista 
    refs:[
    ...
    borrarPregunta:function (grid, record) {
        ...
        // mejor un controller no dependa de datos de pantalla (record) de otro controller, mejor pasar datos b�sicos o un dto nuevo
